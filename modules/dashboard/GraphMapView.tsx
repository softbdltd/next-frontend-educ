...
import Layout from './SystemAdminDashboard/Layout';
...
const GraphMapView = () => {
      ...
      (async () => {
        try {
          const statisticsData = await getMapDataStatistics(
            DistrictsIds[district.trim() as keyof typeof DistrictsIds],
          );
          ...
          <a href=${`/cv-bank?loc_division_id=${districtIdsObj.division_id}&loc_district_id=${districtIdsObj.district_id}`}>
          <div style="display: flex; justify-content: space-between; padding: 0 20px 25px 20px">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <div style="width: 100px; height: 100px; border-radius: 50%; background-color: #9e70a7; display: flex; justify-content: center; align-items: center;"  onmouseover="this.style.backgroundColor='#762685'" onmouseleave="this.style.backgroundColor='#9e70a7'" >
            ...
            <a href=${`${educDomain()}/jobs/?search_text=${district.trim()}`}>
            <div style="display: flex; flex-direction: column; align-items: center;"
    >
            ...
            <div style="display: flex; flex-direction: column; align-items: center;">
                <div style="width: 100px; height: 100px; border-radius: 50%; background-color: #488c8c; display: flex; justify-content: center; align-items: center;"  onmouseover="this.style.backgroundColor='#175656'" onmouseleave="this.style.backgroundColor='#488c8c'" >
                    <span style="font-size: 30px; color: white;">${formatNumber(
  ...
  return (
    <Layout title={messages['common.graph_map_title']} titleColor={'#383874'}>
      <Grid container>
        <Grid item xs={12}>
          <Box
            sx={{
