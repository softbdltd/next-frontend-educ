...
import {useFetchTrainingCenterDashboardYearlyEnrollments} from '../../../services/instituteManagement/hooks';
...
const CourseEnrolmentChart = () => {
  ...
  const {data: statisticsData} =
    useFetchTrainingCenterDashboardYearlyEnrollments(statisticsParams);
