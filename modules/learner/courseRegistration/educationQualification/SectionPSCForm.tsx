...
const SectionPscForm: FC<SectionPSCFormProps> = ({
  errors,
  register,
  control,
  getValues,
  ...
  const {
    ...
    changeFormConfig,
    edu_level: 'psc_info',
    edu_level_config_name: 'psc_passing_info',
  });
  return (
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Grid container>
            ...
            {isOnlyVisibleField && !formConfig.psc_passing_info.dataExist && (
              <Grid>
                <FormControlLabel
                  sx={{
                    marginLeft: '0',
        ...
        <Grid item xs={12} md={6}>
          <CustomFilterableFormSelect
            required={
              formConfig.psc_passing_info.required ||
              formConfig.psc_passing_info.dataExist
            }
            id='psc_info[exam_degree_id]'
        ...
        <Grid item xs={12}>
          <CustomCheckbox
            id='psc_info[is_foreign_institute]'
        ...
        {Boolean(isForeignInstitute) && (
          <Grid item xs={12} md={6}>
            <CustomFilterableFormSelect
              ...
              id='psc_info[foreign_institute_country_id]'
        ...
        {selectedResult && ResultCodeDivisions.includes(selectedResult.code) && (
          <Grid item xs={12} md={6}>
            <CustomTextInput
              ...
              id='psc_info[marks_in_percentage]'
              type={'number'}
        ...
        {selectedResult && selectedResult.code == ResultCodeAppeared && (
          <Grid item xs={12} md={6}>
            <CustomFilterableFormSelect
              ...
              id='psc_info[expected_year_of_passing]'
        ...
        <Grid item xs={12} md={6}>
          <FileUploadComponent
            id='psc_info[certificate_file_path]'
