...
const SectionSscForm: FC<SectionSSCFormProps> = ({
  ...
  const {
    ...
    changeFormConfig,
    edu_level: 'ssc_info',
    edu_level_config_name: 'ssc_passing_info',
  });
  return (
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Grid container>
            ...
            {isOnlyVisibleField && !formConfig.ssc_passing_info.dataExist && (
              <Grid>
                <FormControlLabel
                  sx={{
                    marginLeft: '0',
        ...
        <Grid item xs={12} md={6}>
          <CustomFilterableFormSelect
            required={
              formConfig.ssc_passing_info.required ||
              formConfig.ssc_passing_info.dataExist
            }
        ...
        {selectedResult && selectedResult.code != ResultCodeAppeared && (
          <Grid item xs={12} md={6}>
            <CustomFilterableFormSelect
              ...
              errorInstance={errors}
              isDisabled={!formConfig.ssc_passing_info.required}
            />
          </Grid>
        )}
        {selectedResult && selectedResult.code == ResultCodeAppeared && (
        ...
        <Grid item xs={12} md={6}>
          <FileUploadComponent
            id='ssc_info[certificate_file_path]'
