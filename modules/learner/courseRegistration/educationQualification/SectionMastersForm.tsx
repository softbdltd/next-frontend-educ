...
const SectionMastersForm: FC<SectionMastersFormProps> = ({
  ...
  const {
    ...
    formConfig,
    changeFormConfig,
    edu_level: 'masters_info',
    edu_level_config_name: 'masters_passing_info',
  });
  return (
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Grid container>
            ...
            {isOnlyVisibleField && !formConfig.masters_passing_info.dataExist && (
              <Grid>
                <FormControlLabel
                  sx={{
                    marginLeft: '0',
        ...
        <Grid item xs={12} md={6}>
          <CustomFilterableFormSelect
            required={
              formConfig.masters_passing_info.required ||
              formConfig.masters_passing_info.dataExist
            }
        ...
        <Grid item xs={12} md={6}>
          <FileUploadComponent
            id='masters_info[certificate_file_path]'
