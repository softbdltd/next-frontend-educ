...
const SectionJscForm: FC<SectionJSCFormProps> = ({
  ...
  const {
    ...
    changeFormConfig,
    edu_level: 'jsc_info',
    edu_level_config_name: 'jsc_passing_info',
  });
  return (
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Grid container>
            ...
            {isOnlyVisibleField && !formConfig.jsc_passing_info.dataExist && (
              <Grid>
                <FormControlLabel
                  sx={{
                    marginLeft: '0',
        ...
        <Grid item xs={12} md={6}>
          <CustomFilterableFormSelect
            required={
              formConfig.jsc_passing_info.required ||
              formConfig.jsc_passing_info.dataExist
            }
        ...
        <Grid item xs={12} md={6}>
          <FileUploadComponent
            id='jsc_info[certificate_file_path]'
